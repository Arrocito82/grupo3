        ...
        $('.alert').alert('close');
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    document.getElementById('scroll_box').insertAdjacentHTML('afterend',`<div class="alert alert-dark fade show row " role="alert">
                  ...
                  <div class="row">
                      <div class="col-sm-11">
                            <h5 class="my-auto ml-5 d-inline-block" >${result[1]}</h5>
                      </div>
                      <button type="button" class="close col-sm-1 " data-dismiss="alert" aria-label="Close">
